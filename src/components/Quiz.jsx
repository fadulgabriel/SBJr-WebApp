...
const PAUTAS = {
  ...
  "1.5": { titulo: "Como montar e acompanhar uma estratégia uníssona", sala: "Sala 5", empresa: "Bruno Kawano" },
...
const RECOMENDACOES_MAP = {
  ...
  trainee_vendas_processos:     { p1: "1.4", p1alt: "1.5", p2: "2.4", p2alt: "2.5" },
  ...
  trainee_produto_processos:    { p1: "1.4", p1alt: "1.6", p2: "2.5", p2alt: "2.2" },
  trainee_produto_gente:        { p1: "1.5", p1alt: "1.6", p2: "2.6", p2alt: "2.1" },
  trainee_processos_vendas:     { p1: "1.1", p1alt: "1.3", p2: "2.2", p2alt: "2.4" },
  trainee_processos_produto:    { p1: "1.1", p1alt: "1.2", p2: "2.2", p2alt: "2.5" },
  trainee_processos_processos:  { p1: "1.3", p1alt: "1.4", p2: "2.5", p2alt: "2.4" },
  trainee_processos_gente:      { p1: "1.5", p1alt: "1.4", p2: "2.6", p2alt: "2.1" },
  ...
  membro_vendas_processos:      { p1: "1.4", p1alt: "1.6", p2: "2.4", p2alt: "2.5" },
  ...
  membro_produto_processos:     { p1: "1.4", p1alt: "1.6", p2: "2.5", p2alt: "2.2" },
  membro_produto_gente:         { p1: "1.5", p1alt: "1.6", p2: "2.6", p2alt: "2.1" },
  membro_processos_vendas:      { p1: "1.1", p1alt: "1.3", p2: "2.2", p2alt: "2.4" },
  membro_processos_produto:     { p1: "1.1", p1alt: "1.2", p2: "2.2", p2alt: "2.5" },
  membro_processos_processos:   { p1: "1.6", p1alt: "1.3", p2: "2.5", p2alt: "2.4" },
  ...
  membro_gente_processos:       { p1: "1.6", p1alt: "1.5", p2: "2.4", p2alt: "2.1" },
  ...
  lideranca_vendas_processos:   { p1: "1.6", p1alt: "1.3", p2: "2.4", p2alt: "2.6" },
  ...
  lideranca_produto_processos:  { p1: "1.6", p1alt: "1.3", p2: "2.4", p2alt: "2.6" },
  ...
  lideranca_gente_processos:    { p1: "1.6", p1alt: "1.5", p2: "2.6", p2alt: "2.1" },
  lideranca_gente_gente:        { p1: "1.5", p1alt: "1.6", p2: "2.6", p2alt: "2.1" },
};
