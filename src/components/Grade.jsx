...
const SESSIONS = [
  ...
  },
  {
    id: 7, codigo: '1.5',
    tipo: 'Paralela',
    pauta: 'Como montar e acompanhar uma estratégia uníssona',
  ...
  },
  {
    id: 14, codigo: '2.4',
    tipo: 'Paralela',
    pauta: 'Funil de vendas previsível',
...

  {
    ...
    tipo: 'Direto',
    pauta: 'Encerramento',
    descricao: 'O Sábado Júnior 2026 chega ao fim. Obrigado por estar aqui! Agora vai lá e aplique tudo isso.',
    autor: '',
    empresa: '',
    sala: 'Palco Principal',
    horario: '19:00',
